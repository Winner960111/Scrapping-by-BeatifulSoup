...
# url = f"https://whop.com/discover/c/trading/p/5/" # Replace with the URL you want to scrape
...
link = "https://whop.com/discover/vip-19-a41f/"
# if salary == "Free":
#     continue
data['link'] = link
...
# data['affiliate_percentage'] = affiliate_percentage.split("%")[0]

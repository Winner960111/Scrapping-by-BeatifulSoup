...
try:
    ...
    for i in range(0, 3883):
        ...
        for record in records:
            table_link = record['fields']['Trader Name']
            if str(db.iloc[i]['Trading Mentor(s)']) == table_link:
                flag = True
                break
        ...
        new_record_data = {
            "Trader Name": str(db.iloc[i]['Trading Mentor(s)']),
        }
